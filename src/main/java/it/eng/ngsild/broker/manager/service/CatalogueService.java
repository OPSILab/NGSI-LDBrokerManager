...
//	          String identificator = creator.getIdentifier();
...
//	          String identificator = publisher.getIdentifier();
//	          identificator = identificator.replaceAll("[^a-zA-Z0-9]", "");
//
//	          String idDs = "urn:ngsi-ld:id:" + identificator;     
//	          
...
//	            String type = "AgentDCAT-AP";
//	            String agent = publisher.getName();
//	      
//	            String data = "{ \"id\": \"" + idDs + "\", \"type\": \"" + type + "\","
//	                + "\"name\": { " 
//	                + "\"type\": \"Property\","
...
//	          String identificator = holder.getIdentifier();
//	          identificator = identificator.replaceAll("[^a-zA-Z0-9]", "");
//	          String idDs = "urn:ngsi-ld:id:" + identificator; 
//	          
//	          String agentType = "";
//	          if (holder.getType() != null) {
//	        	  agentType = holder.getType();
//	          }
//
//	          String api = urlCB + "entities/" + idDs;
//	          int status = restRequest(api, "", "GET");
...
//	            	checksum = d.getChecksum().getChecksumValue();
//	            }
//
...
//	                + "\"value\": { "
//	                + "\"@type\": \"DateTime\","
//	                + "\"@value\": \"" + d.getReleaseDate() + "\"  }"
//	                + " }, "
//	                + "\"modifiedDate\": { "
//	                + "\"type\": \"Property\","
//	                + "\"value\": { "
//	                + "\"@type\": \"DateTime\","
//	                + "\"@value\": \"" + d.getUpdateDate() + "\"  }"
//	                + " }, "
//	                + "\"accessUrl\": { "
//	                + "\"type\": \"Property\","
//	                + "\"value\": [ \"" + d.getAccessURL() +  "\" ]" 
//	                + " },"
//	                + "\"downloadURL\": { "
//	                + "\"type\": \"Property\","
//	                + "\"value\": [ \"" + d.getDownloadURL() + "\" ]" 
//	                + " },"
//	                + "\"license\": { "
//	                + "\"type\": \"Property\","
//	                + "\"value\": \"" + d.getLicense().getName() + "\""
//	                + " },"
//	                + "\"format\": { "
//	                + "\"type\": \"Property\","
//	                + "\"value\": \"" + format + "\""
...
//	        
//	          // ADDING DATASET
//	          String des = dataset.getDescription();
//	          String descr = des.replaceAll("[^a-zA-Z0-9]", " ");
//	          
//	          String t = dataset.getTitle();
...
//	          String creator = "";
//	          if (dataset.getCreator() != null) {
//	            creator = dataset.getCreator().getName();
//	          }
//	          String publisher = "";
//	          if (dataset.getPublisher() != null) {
...
//	            contacts.add("\"" + v.getHasEmail() + "\""); 
//	          }
////	          if (contacts.size() == 0)
////	        	  contacts.add("");
//	          
//	          ArrayList<String> themes = new ArrayList<String>();
//	          List<SkosConcept> theme = dataset.getTheme();
//	          for(SkosConcept tema: theme) {
...
//	          for (String doc: dataset.getDocumentation()) {
//	          	if(!doc.isBlank())
//	          		documentation.add("\"" + doc + "\"");
//	          }
//
//	          ArrayList<String> language = new ArrayList<String>();
//	          for (String lan: dataset.getLanguage()) {
//	          	if(!lan.isBlank())
//	          		language.add("\"" + lan + "\"");
//	          }
//	          ArrayList<String> otherIdentifier = new ArrayList<String>();
//	          for (String otId: dataset.getOtherIdentifier()) {
//	          	if(!otId.isBlank()) {
//	          		otherIdentifier.add("\"" + otId + "\"");
//	          	}
//	          }
//	          ArrayList<String> provenance = new ArrayList<String>();
//	          for (String pr: dataset.getProvenance()) {
//	          	if(!pr.isBlank())
//	          		provenance.add("\"" + pr + "\"");
//	          }
//	          String frequency = "";
...
//	        	  startDate = dataset.getTemporalCoverage().getStartDate();
//	        	  endDate = dataset.getTemporalCoverage().getEndDate();
//	          }
//	          String version = "";
...
//	          }
//	          
//	          //TODO: farlo dove ci sono array
//	          List<String> versionNotes = dataset.getVersionNotes().stream().filter(s->!s.isBlank()).collect(Collectors.toList());
//
...
//	              + "\"accessRights\": { " 
//	              + "\"type\": \"Property\","
//	              + "\"value\": \"" + dataset.getAccessRights() + "\" },"
//	              + "\"dateCreated\": { "
//	              + "\"type\": \"Property\","
//	              + "\"value\": { "
//	              + "\"@type\": \"DateTime\","
//	              + "\"@value\": \"" + dataset.getReleaseDate() + "\"  }"
//	              + " }, "
//	              + "\"dateModified\": { "
//	              + "\"type\": \"Property\","
//	              + "\"value\": { "
//	              + "\"@type\": \"DateTime\","
//	              + "\"@value\": \"" + dataset.getUpdateDate() + "\"  }"
//	              + " }, "
//	              + "\"publisher\": { " 
//	              + "\"type\": \"Property\","
//	              + "\"value\": \"" + publisher + "\" },"
...
//	              + "\"source\": { " 
//	              + "\"type\": \"Property\","
//	              + "\"value\": \"" + dataset.getLandingPage() + "\" }"		// ricontrolla
//	              + " }";
//	          
...
//	        // 1. CREATORS
//	        if (dataset.getCreator() != null) {
//	          identif = dataset.getCreator().getIdentifier();
...
//	        // 2. PUBLISHERS
//	        if (dataset.getPublisher() != null) {    
//	          identif = dataset.getPublisher().getIdentifier();
//	          identif = identif.replaceAll("[^a-zA-Z0-9]", "");
//	          idDs = "\"urn:ngsi-ld:id:" + identif + "\"";
//	          if (!listId.contains(idDs)) {
//	            listId.add(idDs);
...
//	        // 3. RIGHT HOLDERS
//	        if (dataset.getRightsHolder() != null) {  
//	          identif = dataset.getRightsHolder().getIdentifier();
//	          identif = identif.replaceAll("[^a-zA-Z0-9]", "");
//	          idDs = "\"urn:ngsi-ld:id:" + identif + "\"";
//	          if (!listId.contains(idDs)) {
//	            listId.add(idDs);
